...
export async function createKnowledge(name: string, content: string): Promise<Knowledge> {
...
export async function updateKnowledge(knowledgeId: number, name: string, content: string): Promise<Knowledge> {
